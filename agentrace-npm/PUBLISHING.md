...
git init
git remote add origin https://github.com/RavaniRoshan/agentrace.git
git add .
...
In bin/agentrace.js, update the VERSION constant to match.
...
git add package.json bin/agentrace.js src/server.js src/commands/ui.js
